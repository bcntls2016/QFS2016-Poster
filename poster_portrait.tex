...
\vspace{2px}  
\scriptsize{
\noindent The total energy of the Xe@$^4$He$_{1000}$ complex is written as

\begin{align*}
	E\left[\Psi,\mathbf{r}_{Xe}\right]=\int d\mathbf{r} \frac{\hbar^2}{2m_{He}}\vert\nabla\Psi\vert^2 + \frac{p^2_{Xe}}{2m_{Xe}}
	+\int d\mathbf{r} \mathcal{E}\left(\rho\right) + \int d\mathbf{r}\rho(\mathbf{r})V_{Xe}\left(\mathbf{r}-\mathbf{r}_{Xe}\right)
\end{align*}
...
\begin{align*}
	i\hbar\frac{\partial}{\partial t}\Psi_{He} &= \left[-\frac{\hbar^2}{2m_{He}}\nabla^2+\frac{\delta\mathcal{E}}{\delta\rho(r)}
	+V_{Xe}\left(\mathbf{r}-\mathbf{r}_{Xe}\right)\right]\Psi_{He} \\
	m_{Xe}\ddot{\mathbf{r}}_{Xe} &= -\nabla_{\mathbf{r}_{Xe}}\left[\int d\mathbf{r}\rho(\mathbf{r})V_{Xe}\left(\mathbf{r}-\mathbf{r}_{Xe}\right)\right] = -\int d\mathbf{r}\nabla\rho(\mathbf{r})V_{Xe}\left(\mathbf{r}-\mathbf{r}_{Xe}\right)
\end{align*}
...
\end{center}
\vspace{-5px}
\noindent On the far right a phase-diagram is shown that demonstrates that the average velocity of the Xe atom in the droplet is lower than the Landau critical velocity, and that it is independent of the initial velocity.
